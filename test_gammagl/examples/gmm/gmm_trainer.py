...
if __name__ == '__main__':
    ...
    parser.add_argument("--lr", type=float, default=0.006, help="learning rate")  # 0.001、0.005、0.01
    parser.add_argument("--drop_rate", type=float, default=0.6, help="drop_rate")  # cora 0.5-0.9 pubmet 0.4-0.8
    parser.add_argument("--n_epoch", type=int, default=100, help="number of epoch")
    parser.add_argument("--hidden_dim", type=int, default=16, help="dimention of hidden layers")  # 16\32\64 (32比较好)
    ...
    parser.add_argument("--l2_coef", type=float, default=0.005, help="l2 loss coeficient")  # 1、2、5/-5、-4、-3
